  ...
  items = [
    {
      ...
      icon: <ScanFace className="size-5 stroke-1" />,
    },
    {
      title: "Responsive design",
      description: "Looks and works great on any device and screen size",
      icon: <MonitorSmartphone className="size-5 stroke-1" />,
    },
    {
    ...
    },
    {
      ...
      icon: <Blocks className="size-5 stroke-1" />,
    },
    {
      title: "Top-level performance",
      description: "Made for lightning-fast load times and smooth interactions",
      icon: <FastForward className="size-5 stroke-1" />,
    },
    {
    ...
    },
    {
      ...
      icon: <Languages className="size-5 stroke-1" />,
    },
    {
      title: "CMS friendly",
      description:
        "Built to work with your any headless content management system",
      icon: <Pen className="size-5 stroke-1" />,
    },
  ],
  className,
}: ItemsProps) {
