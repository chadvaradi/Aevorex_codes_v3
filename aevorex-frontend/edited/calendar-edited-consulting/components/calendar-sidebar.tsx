...
import { TeamSwitcher } from "@/launch-ui-pro-2.3.3/ui/team-switcher";
import { Checkbox } from "@/launch-ui-pro-2.3.3/ui/checkbox";
    ...
    >
      <div className="flex items-center gap-4">
        <TeamSwitcher
          teams={[
            {
              name: "Aevorex",
              logo: (props: any) => <Aevorex {...props} size="large" className="size-6" />,
              plan: "Enterprise",
            },
          ]}
        />
      ...
      <div className="mt-auto p-2">
        <Button
          ...
          title={!calendlyUrl ? "Calendly URL is not configured" : "Open booking"}
