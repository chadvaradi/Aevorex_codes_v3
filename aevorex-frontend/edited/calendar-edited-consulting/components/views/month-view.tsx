  ...
  return (
    <div className="h-full w-full text-left">
      <div className="flex h-full flex-col">
        {/* Days header row */}
        <div className="border-border dark:border-border/15 flex border-b min-w-0 overflow-hidden">
        ...
        {/* Month grid */}
        <div className="flex-1 min-w-0 overflow-x-auto sm:overflow-x-visible">
          {/* 7 oszlop komfortosan kifér (kb 96px/oszlop + padding) → 680px */}
          <div className="grid grid-cols-7 grid-rows-6 min-w-[680px]">
