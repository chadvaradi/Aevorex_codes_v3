...
import RisingIllustration from "@/edited/illustrations-edited/rising-large";
...
export default function FeatureIllustrationBottom({
  ...
  description = "AI-powered financial analysis designed for beginners who want information fast.",
