...
import { Item, ItemIcon, ItemTitle, ItemDescription } from "@/launch-ui-pro-2.3.3/ui/item";
...
export default function Items({
  ...
  items = [
    ...
    },
    {
      ...
      icon: <File className="size-5 stroke-1" />,
    },
    {
    ...
    },
    {
      ...
      icon: <Linkedin className="size-5 stroke-1" />,
    },
    {
    ...
    },
    {
      ...
      icon: <Mail className="size-5 stroke-1" />,
    },
    {
