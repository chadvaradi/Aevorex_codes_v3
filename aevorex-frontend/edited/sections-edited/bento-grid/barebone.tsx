  ...
  tiles = [
    {
      ...
      description: "From EODHD market data to FRED economic indicators and Euribor rates — all integrated into one AI-powered research hub. Exportable and audit-friendly.",
